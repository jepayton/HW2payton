...
>Yes, one NA value only in county_df. No NA values in county_MI.

* What differences do you notice between the structure of the two data frames?
county_MI has an additional variable (peninsula) for a total of 41 variables; county_df has only 40 variables.
